  ...
  <div class="construction-message">
    ...
    <g id="large">
      <g>
        ...
        c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z"  fill="none" stroke="#000"/>    <animateTransform
    ...
    <g id="small">
      ...
      C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#000"/>
      <animateTransform
      attributeName="transform"
      begin="0s"
      dur="2s"
...
<h2>Sorry for the inconvenience.<br>To contact us in the meantime please email info@asc.org.in</h2>
</body>
</html>
